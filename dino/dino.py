...
pygame.display.set_caption('Dinossauro do Googre')

sprite_sheet = pygame.image.load(os.path.join(diretorio_imagens, 'dinodino.png')).convert_alpha()
...
while True:
    ...
    if colidiu == True:
        ...
        restart = exibe_mensagem('Aperte r ou seja um fóssil', 20, (0,0,0))
